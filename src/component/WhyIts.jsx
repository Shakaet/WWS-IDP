...
const cards = [
  {
    ...
    cta: { label: 'Learn More', to: 'http://localhost:5173/fast-efficient-details' },
    icon: (
  ...
  },
  {
    ...
    cta: { label: 'Learn More', to: 'http://localhost:5173/creative-solutions' },
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="h-8 w-8">
  ...
  },
  {
    ...
    cta: { label: 'Learn More', to: 'http://localhost:5173/client-focused' },
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="h-8 w-8">
  ...
  },
  {
    ...
    cta: { label: 'Start preparing', to: 'http://localhost:5173/ielts-and-test' },
    icon: (
  ...
  },
  {
    ...
    cta: { label: 'Find support near you', to: 'http://localhost:5173/global-reach' },
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="h-7 w-7">
